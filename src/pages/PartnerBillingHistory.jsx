// src/pages/PartnerBillingHistory.jsx
import { AlertTriangle, Calendar, CheckCircle, Clock, DollarSign, Download, FileText, Filter } from 'lucide-react';
...
const PartnerBillingHistory = () => {
  ...
  if (!isPartner) {
    return (
      <div className="partner-billing-history-page">
        <div className="access-denied">
          <h1>{t('common.accessDenied')}</h1>
          <p>This page is only accessible to partner accounts.</p>
          <p style={{ fontSize: '0.875rem', color: '#64748b', marginTop: '1rem' }}>
            Debug info: Role = "{profile?.role || 'undefined'}", Partner UUID = {profile?.partner_uuid ? '✓ Present' : '✗ Missing'}
          </p>
          <p style={{ fontSize: '0.875rem', color: '#64748b', marginTop: '0.5rem' }}>
            If you are a partner and seeing this message, please contact support.
          </p>
        </div>
      </div>
    );
  ...
  if (loading) {
    return <div className="partner-billing-history-loading">{t('common.loading')}</div>;
  }
      ...
      <div className="billing-stats-grid">
        ...
        <div className="stat-card total-amount">
          ...
          <div className="stat-content">
            ...
            <div className="stat-value">{formatCurrency(stats.totalAmount, payments[0]?.currency)}</div>
          </div>
        </div>
      </div>
...
export default PartnerBillingHistory;